...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <!-- title of site -->
        <title>Cantara Enterprises</title>

        <!-- For favicon jpg -->
		<link rel="shortcut icon" type="image/icon" href="assets/logo/favicon-32x32.jpg"/>
	...
	<body>
										...
										<div class="col-sm-7">
											<div class="single-welcome-hero">
												<div class="welcome-hero-txt">
													<h4>great construction collection</h4>
								...
								<div class="welcome-hero-content">
									<div class="row">
										<div class="col-sm-7">
											<div class="single-welcome-hero">
												<div class="welcome-hero-txt">
													<h4>great material collection</h4>
													<h2>building material</h2>
													<p>
														Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiuiana smod tempor  ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip. 
													</p>
				    ...
				    <nav class="navbar navbar-default bootsnav  navbar-sticky navbar-scrollspy"  data-minus-value-desktop="70" data-minus-value-mobile="55" data-speed="1000">
				        ...
				        <div class="container">            
				                    ...
				                    <li class="dropdown">
				                        ...
				                        <ul class="dropdown-menu cart-list s-cate">
				                            <li class="single-cart-list">
				                                <a href="#" class="photo"><img src="assets/images/collection/arrivals1.jpg" class="cart-thumb" alt="image" /></a>
				                                <div class="cart-list-txt">
				                                	<h6><a href="#">arm <br> chair</a></h6>
				                                	<p>1 x - <span class="price">Ksh.180.00</span></p>
				                                </div><!--/.cart-list-txt-->
				                            ...
				                            <li class="single-cart-list">
				                                <a href="#" class="photo"><img src="assets/images/collection/arrivals2.jpg" class="cart-thumb" alt="image" /></a>
				                                <div class="cart-list-txt">
				                            ...
				                            <li class="single-cart-list">
				                                <a href="#" class="photo"><img src="assets/images/collection/arrivals3.jpg" class="cart-thumb" alt="image" /></a>
				                                <div class="cart-list-txt">
				            ...
				            <div class="navbar-header">
				                ...
				                <a class="navbar-brand" href="index.html"><img src="assets/logo/logoC.png"></a>
							

								<!-- Cantara<span>Enterprises</span>. -->
				            ...
				            <div class="collapse navbar-collapse menu-ui-design" id="navbar-menu">
				                <ul class="nav navbar-nav navbar-center" data-in="fadeInDown" data-out="fadeOutUp">
				                    ...
				                    <li class="scroll"><a href="#new-arrivals">projects</a></li>
									...
									<div class="row">
										<div class="col-md-4 col-sm-12">
											<div class="single-inner-populer-product-img">
												<img src="assets/images/populer-products/p2.jpg" alt="populer-products images">
											</div>
										</div>
										<div class="col-md-8 col-sm-12">
											<div class="single-inner-populer-product-txt">
												<h2>
													<a href="#">
														latest designed roofing <span>and</span> gaters
													</a>
												</h2>
												<p>
												...
												<div class="populer-products-price">
													<h4>Sales Start from <span>Ksh.99.00</span></h4>
												</div>
					...
					<div class="row">
						<div class="col-md-3 col-sm-4">
							<div class="single-new-arrival">
								...
								<h4><a href="#">Cement</a></h4>
								<p class="arrival-product-price">Ksh.65.00</p>
							</div>
						</div>
						<div class="col-md-3 col-sm-4">
							<div class="single-new-arrival">
								...
								<h4><a href="#">cement</a></h4>
								<p class="arrival-product-price">Ksh.80.00</p>
							</div>
						</div>
						<div class="col-md-3 col-sm-4">
							<div class="single-new-arrival">
								...
								<h4><a href="#">Cement</a></h4>
								<p class="arrival-product-price">Ksh.40.00</p>
							</div>
						</div>
						<div class="col-md-3 col-sm-4">
							<div class="single-new-arrival">
								...
								<h4><a href="#">Cement</a></h4>
								<p class="arrival-product-price">Ksh.100.00</p>
							</div>
						</div>
						<div class="col-md-3 col-sm-4">
							<div class="single-new-arrival">
								...
								<h4><a href="#">Cement</a></h4>
								<p class="arrival-product-price">Ksh.120.00</p>
							</div>
						</div>
						<div class="col-md-3 col-sm-4">
							<div class="single-new-arrival">
								...
								<h4><a href="#">Cement</a></h4>
								<p class="arrival-product-price">Ksh.140.00</p>
							</div>
						</div>
						<div class="col-md-3 col-sm-4">
							<div class="single-new-arrival">
								...
								<h4><a href="#">Cement</a></h4>
								<p class="arrival-product-price">Ksh.90.00</p>
							</div>
						</div>
						<div class="col-md-3 col-sm-4">
							<div class="single-new-arrival">
		...
		<section id="sofa-collection">
			<div class="owl-carousel owl-theme" id="collection-carousel">
				<div class="sofa-collection collectionbg01">
					<div class="container">
						<div class="sofa-collection-txt">
							<h2>unlimited building Materials</h2>
							<p>
								Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. 
							</p>
							<div class="sofa-collection-price">
								<h4>strting from <span>Shillings 199</span></h4>
							</div>
				...
				<div class="sofa-collection collectionbg02">
					<div class="container">
						<div class="sofa-collection-txt">
							<h2>unlimited fixes</h2>
							<p>
								Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. 
							</p>
							<div class="sofa-collection-price">
								<h4>strting from <span>Ksh. 299</span></h4>
							</div>
							<button class="btn-cart welcome-add-cart sofa-collection-btn" onclick="window.location.href='#'">
								view more
							</button>
		...
		<section id="clients"  class="clients">
			<div class="container">
				<div class="owl-carousel owl-theme" id="client">
						<div class="item">
							<a href="#">
								<img src="assets/images/clients/c1.jpg" alt="brand-image" />
							</a>
						</div><!--/.item-->
						<div class="item">
							<a href="#">
						...
						<div class="item">
							<a href="#">
								<img src="assets/images/clients/c5.jpg" alt="brand-image" />
							</a>
						</div><!--/.item-->
					</div><!--/.owl-carousel-->
		...
		<footer id="footer"  class="footer">
			<div class="container">
				<div class="hm-footer-copyright text-center">
					...
					<p>
						&copy;copyright. designed and developed by <a href="https://www.techlait.com/">techlait</a>
					</p><!--/p-->
				</div><!--/.text-center-->
			</div><!--/.container-->
